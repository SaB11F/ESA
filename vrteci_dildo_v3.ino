...
//definicija pina za joy stick switch
#define SW_PIN 4
...
void joystickButton(){
  ifI(digitalRead(SW_PIN) == LOW){
    Serial.println("Pritisnjeno");
    //koda s pomočjo katere pošljemo signal na CanSat
    //CanSat spozna, da mora ko je ta gumb pritisnjen odpreti nogice
  }
}
